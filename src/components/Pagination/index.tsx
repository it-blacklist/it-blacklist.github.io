...
export default ({ pagination: { current, total, pageSize }, onPageChange }: any) => {
  ...
  const pushSecondArray = (index: any) => {
  ...
  return (
    <View style={{ margin: '20px 0', display: 'flex' }}>
      ...
      <Picker mode="multiSelector" onChange={pickerConfirm} onColumnChange={pickerChange}
