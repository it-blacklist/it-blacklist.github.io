...
import {
  View,pageScrollTo, stopPullDownRefresh, showLoading, hideLoading
} from 'remax/wechat'
...
export default () => {
  ...
  return (
    <View data-weui-theme="light">
      <SearchBar placeholder="输入公司名称搜索" bindinput={e=>setSearchVal(e.detail.value)} bindclear={()=>setSearchVal('')} value={searchVal}/>
      <Cells>
